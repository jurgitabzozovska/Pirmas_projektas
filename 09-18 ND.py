...
def create_and_insert_product():
    ...
    create_table_query = """
           CREATE TABLE IF NOT EXISTS baldu_turgus_products (
    ...
    for i in range(1, 100):
        url = 'https://balduturgus.lt/baldai/stalai/?p={i}'
    ...
    for product_element in product_elements:
        ...
        # insert_query ="INSERT INTO baldu_turgus_products (name, price, quantity) VALUES(%s, %s, %s)"
    ...
    connection.commit()
        ...
        # print(df)
    select_query = "SELECT * FROM baldu_turgus_products"
